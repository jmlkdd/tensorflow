...
def test_cPickle():
    filename = '/Users/haizhi/work/data/handwritedigits/t10k-images-idx3-ubyte.gz'
...
def test():
    trainfile_X = '/Users/haizhi/work/data/handwritedigits/t10k-images-idx3-ubyte'
    trainfile_y = '/Users/haizhi/work/data/handwritedigits/t10k-labels-idx1-ubyte'
    arrX = getImage(trainfile_X)
    arrY = getlable(trainfile_y)
    print 'x len', len(arrX), arrX.shape
    print 'y len', len(arrY), arrY.shape, arrY[:10]
    outImg(arrX, arrY, 9)
